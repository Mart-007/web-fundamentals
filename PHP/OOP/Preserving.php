<?php
// Preserving
// In the last lesson, we saw how we can overwrite an existing property or method in our inherited class, but what if we want to keep the existing method and add something additional to it? We can use the scope resolution operator (::) to call the function from our parent class within the class we are overwriting.
...
class Wizardcopy extends Human
{
