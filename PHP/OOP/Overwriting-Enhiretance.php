...
<?php
// Overwriting
// In most cases, you would want to keep the properties and methods that you were inheriting from your parent class, but if you wanted to create a method or property to take the place of the existing one in the parent class you would just overwrite it.
